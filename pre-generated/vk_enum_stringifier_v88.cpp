...
constexpr uint32_t generatedVulkanVersion = 88u;

constexpr const char *vendorTags[] = {
    "IMG",       "AMD",    "AMDX", "ARM",    "FSL",     "BRCM",    "NXP",
    "NV",        "NVX",    "VIV",  "VSI",    "KDAB",    "ANDROID", "CHROMIUM",
    "FUCHSIA",   "GOOGLE", "QCOM", "LUNARG", "SAMSUNG", "SEC",     "TIZEN",
    "RENDERDOC", "NN",     "MVK",  "KHR",    "KHX",     "EXT",     "MESA",
};
constexpr std::size_t vendorTagCount = 28;
...
EnumDeclaration enumTypes[] = {
    ...
    {"VkGeometryInstanceFlagBitsNVX", 4},
    {"VkGeometryFlagBitsNVX", 2},
    {"VkBuildAccelerationStructureFlagBitsNVX", 5},
    {"VkCopyAccelerationStructureModeNVX", 2},
    {"VkAccelerationStructureTypeNVX", 2},
    {"VkGeometryTypeNVX", 2},
};
constexpr std::size_t enumTypesCount = 131;
...
constexpr EnumValueSet VkGeometryInstanceFlagBitsNVXSets[] = {
    ...
    {"TRIANGLE_CULL_FLIP_WINDING_BIT", 0x00000002},
...
constexpr const EnumValueSet *valueSets[] = {
    ...
    VkGeometryInstanceFlagBitsNVXSets,
    VkGeometryFlagBitsNVXSets,
    VkBuildAccelerationStructureFlagBitsNVXSets,
    VkCopyAccelerationStructureModeNVXSets,
    VkAccelerationStructureTypeNVXSets,
    VkGeometryTypeNVXSets,
};
