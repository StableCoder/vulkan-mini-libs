...
constexpr uint32_t generatedVulkanVersion = 143u;
...
EnumDeclaration enumTypes[] = {
    ...
    {"VkPrivateDataSlotCreateFlagBitsEXT", 0},
    ...
    {"VkBuildAccelerationStructureFlagBitsKHR", 5},
    {"VkCopyAccelerationStructureModeKHR", 4},
    {"VkAccelerationStructureTypeKHR", 2},
    {"VkGeometryTypeKHR", 2},
    {"VkAccelerationStructureMemoryRequirementsTypeKHR", 3},
...
constexpr std::size_t enumTypesCount = 170;
...
constexpr EnumValueSet VkVendorIdSets[] = {
    {"VK_VENDOR_ID", 0x10001}, {"VK_VENDOR_ID", 0x10002}, {"KAZAN", 0x10003},
    {"CODEPLAY", 0x10004},     {"VK_VENDOR_ID", 0x10005},
};
...
constexpr const EnumValueSet *valueSets[] = {
    ...
    VkIndirectCommandsLayoutUsageFlagBitsNVSets,
    VkIndirectStateFlagBitsNVSets,
    VkIndirectCommandsTokenTypeNVSets,
    nullptr,
    nullptr,
    ...
    VkGeometryInstanceFlagBitsKHRSets,
    VkGeometryFlagBitsKHRSets,
    VkBuildAccelerationStructureFlagBitsKHRSets,
    VkCopyAccelerationStructureModeKHRSets,
    VkAccelerationStructureTypeKHRSets,
    VkGeometryTypeKHRSets,
    VkAccelerationStructureMemoryRequirementsTypeKHRSets,
    VkAccelerationStructureBuildTypeKHRSets,
    VkRayTracingShaderGroupTypeKHRSets,
    VkMemoryOverallocationBehaviorAMDSets,
    nullptr,
    VkScopeNVSets,
    VkComponentTypeNVSets,
    VkDeviceDiagnosticsConfigFlagBitsNVSets,
