 ...
 * that is located at https://github.com/stablecoder/vulkan-stringifier
 * or https://git.stabletec.com/utilities/vulkan-stringifier
 *
...
constexpr uint32_t generatedVulkanVersion = 136u;
...
constexpr std::size_t enumTypesCount = 169;
