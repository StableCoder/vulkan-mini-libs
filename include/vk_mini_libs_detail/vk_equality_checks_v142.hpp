...
#ifndef VK_EQUALITY_CHECK_V142_HPP
#define VK_EQUALITY_CHECK_V142_HPP
...
static_assert(VK_HEADER_VERSION == 142, "Wrong VK_HEADER_VERSION!" );
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkAccelerationStructureMemoryRequirementsInfoKHR const &lhs,
                VkAccelerationStructureMemoryRequirementsInfoKHR const &rhs) noexcept;
bool operator!=(VkAccelerationStructureMemoryRequirementsInfoKHR const &lhs,
                VkAccelerationStructureMemoryRequirementsInfoKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkPhysicalDeviceRayTracingFeaturesKHR const &lhs,
                VkPhysicalDeviceRayTracingFeaturesKHR const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceRayTracingFeaturesKHR const &lhs,
                VkPhysicalDeviceRayTracingFeaturesKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkPhysicalDeviceRayTracingPropertiesKHR const &lhs,
                VkPhysicalDeviceRayTracingPropertiesKHR const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceRayTracingPropertiesKHR const &lhs,
                VkPhysicalDeviceRayTracingPropertiesKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkStridedBufferRegionKHR const &lhs,
                VkStridedBufferRegionKHR const &rhs) noexcept;
bool operator!=(VkStridedBufferRegionKHR const &lhs,
                VkStridedBufferRegionKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkAccelerationStructureBuildOffsetInfoKHR const &lhs,
                VkAccelerationStructureBuildOffsetInfoKHR const &rhs) noexcept;
bool operator!=(VkAccelerationStructureBuildOffsetInfoKHR const &lhs,
                VkAccelerationStructureBuildOffsetInfoKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkAccelerationStructureCreateGeometryTypeInfoKHR const &lhs,
                VkAccelerationStructureCreateGeometryTypeInfoKHR const &rhs) noexcept;
bool operator!=(VkAccelerationStructureCreateGeometryTypeInfoKHR const &lhs,
                VkAccelerationStructureCreateGeometryTypeInfoKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkDeferredOperationInfoKHR const &lhs,
                VkDeferredOperationInfoKHR const &rhs) noexcept;
bool operator!=(VkDeferredOperationInfoKHR const &lhs,
                VkDeferredOperationInfoKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
bool operator==(VkPhysicalDeviceRayTracingFeaturesKHR const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         (lhs.pNext == rhs.pNext) &&
         (lhs.rayTracing == rhs.rayTracing) &&
         (lhs.rayTracingShaderGroupHandleCaptureReplay == rhs.rayTracingShaderGroupHandleCaptureReplay) &&
         (lhs.rayTracingShaderGroupHandleCaptureReplayMixed == rhs.rayTracingShaderGroupHandleCaptureReplayMixed) &&
         (lhs.rayTracingAccelerationStructureCaptureReplay == rhs.rayTracingAccelerationStructureCaptureReplay) &&
         (lhs.rayTracingIndirectTraceRays == rhs.rayTracingIndirectTraceRays) &&
         (lhs.rayTracingIndirectAccelerationStructureBuild == rhs.rayTracingIndirectAccelerationStructureBuild) &&
         (lhs.rayTracingHostAccelerationStructureCommands == rhs.rayTracingHostAccelerationStructureCommands) &&
         (lhs.rayQuery == rhs.rayQuery) &&
         (lhs.rayTracingPrimitiveCulling == rhs.rayTracingPrimitiveCulling);
}
...
bool operator==(VkAccelerationStructureCreateGeometryTypeInfoKHR const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.maxPrimitiveCount == rhs.maxPrimitiveCount) &&
         (lhs.indexType == rhs.indexType) &&
         (lhs.maxVertexCount == rhs.maxVertexCount) &&
         (lhs.vertexFormat == rhs.vertexFormat) &&
         (lhs.allowsTransforms == rhs.allowsTransforms);
}
...
bool operator==(VkRayTracingPipelineInterfaceCreateInfoKHR const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.maxCallableSize == rhs.maxCallableSize);
}
...
#endif // VK_EQUALITY_CHECK_V142_HPP
