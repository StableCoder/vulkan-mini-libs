...
#ifndef VK_VALUE_SERIALIZATION_V104_HPP
#define VK_VALUE_SERIALIZATION_V104_HPP
...
constexpr std::array<std::string_view, 28> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
constexpr std::array<EnumType, 143> enumTypes = {{
  ...
  {"VkStencilFaceFlagBits", VkStencilFaceFlagBitsSets, 3},
  ...
  {"VkValidationFeatureEnableEXT", VkValidationFeatureEnableEXTSets, 2},
  ...
  {"VkVendorId", VkVendorIdSets, 3},
  {"VkDriverIdKHR", VkDriverIdKHRSets, 10},
...
#endif // VK_VALUE_SERIALIZATION_V104_HPP
