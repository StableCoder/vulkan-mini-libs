...
#ifndef VK_VALUE_SERIALIZATION_V86_HPP
#define VK_VALUE_SERIALIZATION_V86_HPP
...
constexpr std::array<EnumType, 130> enumTypes = {{
  ...
  {"VkDriverIdKHR", VkDriverIdKHRSets, 9},
...
#endif // VK_VALUE_SERIALIZATION_V86_HPP
