...
#ifndef VK_STRUCT_CLEANUP_V90_HPP
#define VK_STRUCT_CLEANUP_V90_HPP
...
void vk_struct_cleanup(void const *pData) {
    ...
    case VK_STRUCTURE_TYPE_MIR_SURFACE_CREATE_INFO_KHR:
        {   // VkMirSurfaceCreateInfoKHR
            VkMirSurfaceCreateInfoKHR const *pStruct = static_cast<VkMirSurfaceCreateInfoKHR const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES:
        {   // VkPhysicalDeviceVariablePointerFeatures
            VkPhysicalDeviceVariablePointerFeatures const *pStruct = static_cast<VkPhysicalDeviceVariablePointerFeatures const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETER_FEATURES:
        {   // VkPhysicalDeviceShaderDrawParameterFeatures
            VkPhysicalDeviceShaderDrawParameterFeatures const *pStruct = static_cast<VkPhysicalDeviceShaderDrawParameterFeatures const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_RAYTRACING_PIPELINE_CREATE_INFO_NVX:
        {   // VkRaytracingPipelineCreateInfoNVX
            VkRaytracingPipelineCreateInfoNVX const *pStruct = static_cast<VkRaytracingPipelineCreateInfoNVX const *>(pData);
            ...
            // uint32_t - pGroupNumbers / stageCount
            free(const_cast<uint32_t *>(pStruct->pGroupNumbers));
        }
    ...
    case VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NVX:
        {   // VkGeometryTrianglesNVX
            VkGeometryTrianglesNVX const *pStruct = static_cast<VkGeometryTrianglesNVX const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_GEOMETRY_AABB_NVX:
        {   // VkGeometryAABBNVX
            VkGeometryAABBNVX const *pStruct = static_cast<VkGeometryAABBNVX const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_GEOMETRY_NVX:
        {   // VkGeometryNVX
            VkGeometryNVX const *pStruct = static_cast<VkGeometryNVX const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NVX:
        {   // VkAccelerationStructureCreateInfoNVX
            VkAccelerationStructureCreateInfoNVX const *pStruct = static_cast<VkAccelerationStructureCreateInfoNVX const *>(pData);

            // void - pNext
            vk_struct_cleanup(pStruct->pNext);
            free(const_cast<void *>(pStruct->pNext));

            // VkGeometryNVX - pGeometries / geometryCount
            for (uint32_t i = 0; i < pStruct->geometryCount; ++i)
                vk_struct_cleanup(&pStruct->pGeometries[i]);
            free(const_cast<VkGeometryNVX *>(pStruct->pGeometries));
        }
    ...
    case VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NVX:
        {   // VkBindAccelerationStructureMemoryInfoNVX
            VkBindAccelerationStructureMemoryInfoNVX const *pStruct = static_cast<VkBindAccelerationStructureMemoryInfoNVX const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_DESCRIPTOR_ACCELERATION_STRUCTURE_INFO_NVX:
        {   // VkDescriptorAccelerationStructureInfoNVX
            VkDescriptorAccelerationStructureInfoNVX const *pStruct = static_cast<VkDescriptorAccelerationStructureInfoNVX const *>(pData);

            // void - pNext
            vk_struct_cleanup(pStruct->pNext);
            free(const_cast<void *>(pStruct->pNext));

            // VkAccelerationStructureNVX - pAccelerationStructures / accelerationStructureCount
            free(const_cast<VkAccelerationStructureNVX *>(pStruct->pAccelerationStructures));
        }
    ...
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NVX:
        {   // VkAccelerationStructureMemoryRequirementsInfoNVX
            VkAccelerationStructureMemoryRequirementsInfoNVX const *pStruct = static_cast<VkAccelerationStructureMemoryRequirementsInfoNVX const *>(pData);
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAYTRACING_PROPERTIES_NVX:
        {   // VkPhysicalDeviceRaytracingPropertiesNVX
            VkPhysicalDeviceRaytracingPropertiesNVX const *pStruct = static_cast<VkPhysicalDeviceRaytracingPropertiesNVX const *>(pData);
...
#endif // VK_STRUCT_CLEANUP_V90_HPP
