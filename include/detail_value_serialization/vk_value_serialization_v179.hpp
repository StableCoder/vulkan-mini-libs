...
#ifndef VK_VALUE_SERIALIZATION_V179_HPP
#define VK_VALUE_SERIALIZATION_V179_HPP
...
static_assert(VK_HEADER_VERSION == 179, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<std::string_view, 34> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
constexpr std::array<EnumType, 199> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V179_HPP
