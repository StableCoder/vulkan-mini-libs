...
#ifndef VK_VALUE_SERIALIZATION_V162_HPP
#define VK_VALUE_SERIALIZATION_V162_HPP
...
static_assert(VK_HEADER_VERSION == 162, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<std::string_view, 31> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
#endif // VK_VALUE_SERIALIZATION_V162_HPP
