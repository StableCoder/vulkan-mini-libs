...
#ifndef VK_VALUE_SERIALIZATION_V81_HPP
#define VK_VALUE_SERIALIZATION_V81_HPP
...
constexpr std::array<std::string_view, 27> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
#endif // VK_VALUE_SERIALIZATION_V81_HPP
