...
#ifndef VK_VALUE_SERIALIZATION_V107_HPP
#define VK_VALUE_SERIALIZATION_V107_HPP
...
constexpr std::array<std::string_view, 29> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
constexpr std::array<EnumType, 143> enumTypes = {{
  ...
  {"VkDriverIdKHR", VkDriverIdKHRSets, 11},
...
#endif // VK_VALUE_SERIALIZATION_V107_HPP
