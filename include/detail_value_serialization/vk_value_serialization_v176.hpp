...
#ifndef VK_VALUE_SERIALIZATION_V176_HPP
#define VK_VALUE_SERIALIZATION_V176_HPP
...
static_assert(VK_HEADER_VERSION == 176, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<EnumType, 198> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V176_HPP
