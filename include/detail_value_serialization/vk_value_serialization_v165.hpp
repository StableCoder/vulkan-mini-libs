...
#ifndef VK_VALUE_SERIALIZATION_V165_HPP
#define VK_VALUE_SERIALIZATION_V165_HPP
...
static_assert(VK_HEADER_VERSION == 165, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<std::string_view, 32> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
constexpr std::array<EnumType, 177> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V165_HPP
