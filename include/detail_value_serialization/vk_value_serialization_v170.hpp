...
#ifndef VK_VALUE_SERIALIZATION_V170_HPP
#define VK_VALUE_SERIALIZATION_V170_HPP
...
static_assert(VK_HEADER_VERSION == 170, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<std::string_view, 33> vendors = {{
  "IMG",
  "AMD",
  "AMDX",
  "ARM",
...
constexpr std::array<EnumType, 181> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V170_HPP
