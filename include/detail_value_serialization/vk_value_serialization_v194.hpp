...
#ifndef VK_VALUE_SERIALIZATION_V194_HPP
#define VK_VALUE_SERIALIZATION_V194_HPP
...
static_assert(VK_HEADER_VERSION == 194, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<EnumType, 204> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V194_HPP
