...
#ifndef VK_VALUE_SERIALIZATION_V193_HPP
#define VK_VALUE_SERIALIZATION_V193_HPP
...
static_assert(VK_HEADER_VERSION == 193, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<EnumType, 202> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V193_HPP
