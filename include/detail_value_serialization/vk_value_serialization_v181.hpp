...
#ifndef VK_VALUE_SERIALIZATION_V181_HPP
#define VK_VALUE_SERIALIZATION_V181_HPP
...
static_assert(VK_HEADER_VERSION == 181, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<EnumType, 200> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V181_HPP
