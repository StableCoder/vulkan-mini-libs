...
#ifndef VK_VALUE_SERIALIZATION_V195_HPP
#define VK_VALUE_SERIALIZATION_V195_HPP
...
static_assert(VK_HEADER_VERSION == 195, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<EnumType, 205> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V195_HPP
