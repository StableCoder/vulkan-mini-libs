...
#ifndef VK_VALUE_SERIALIZATION_V82_HPP
#define VK_VALUE_SERIALIZATION_V82_HPP
...
constexpr std::array<EnumType, 120> enumTypes = {{
  ...
  {"VkColorSpaceKHR", VkColorSpaceKHRSets, 1},
...
#endif // VK_VALUE_SERIALIZATION_V82_HPP
