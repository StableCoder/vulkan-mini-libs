...
#ifndef VK_VALUE_SERIALIZATION_V186_HPP
#define VK_VALUE_SERIALIZATION_V186_HPP
...
static_assert(VK_HEADER_VERSION == 186, "Incompatible VK_HEADER_VERSION!");
...
constexpr std::array<EnumType, 201> enumTypes = {{
...
#endif // VK_VALUE_SERIALIZATION_V186_HPP
