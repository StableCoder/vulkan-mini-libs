...
#ifndef VK_EQUALITY_CHECK_V178_HPP
#define VK_EQUALITY_CHECK_V178_HPP
...
bool operator==(VkVideoDecodeH264ProfileEXT const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.fieldLayout == rhs.fieldLayout);
}
...
bool operator==(VkCuLaunchInfoNVX const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.pParams == rhs.pParams) &&
         (lhs.extraCount == rhs.extraCount) &&
         (lhs.pExtras == rhs.pExtras);
}
...
#endif // VK_EQUALITY_CHECK_V178_HPP
