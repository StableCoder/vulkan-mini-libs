...
#ifndef VK_EQUALITY_CHECK_V159_HPP
#define VK_EQUALITY_CHECK_V159_HPP
...
static_assert(VK_HEADER_VERSION == 159, "Incompatible VK_HEADER_VERSION!" );
...
bool operator==(VkAccelerationStructureCreateInfoKHR const &lhs,
  ...
  for(uint32_t i = 0; i < lhs.maxGeometryCount; ++i) {
...
#endif // VK_EQUALITY_CHECK_V159_HPP
