...
#ifndef VK_EQUALITY_CHECK_V204_HPP
#define VK_EQUALITY_CHECK_V204_HPP
...
static_assert(VK_HEADER_VERSION == 204, "Incompatible VK_HEADER_VERSION!" );
...
bool operator==(VkDevicePrivateDataCreateInfo const &lhs,
                VkDevicePrivateDataCreateInfo const &rhs) noexcept;
bool operator!=(VkDevicePrivateDataCreateInfo const &lhs,
                VkDevicePrivateDataCreateInfo const &rhs) noexcept;

bool operator==(VkPrivateDataSlotCreateInfo const &lhs,
                VkPrivateDataSlotCreateInfo const &rhs) noexcept;
bool operator!=(VkPrivateDataSlotCreateInfo const &lhs,
                VkPrivateDataSlotCreateInfo const &rhs) noexcept;

bool operator==(VkPhysicalDevicePrivateDataFeatures const &lhs,
                VkPhysicalDevicePrivateDataFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDevicePrivateDataFeatures const &lhs,
                VkPhysicalDevicePrivateDataFeatures const &rhs) noexcept;
...
bool operator==(VkDeviceBufferMemoryRequirements const &lhs,
                VkDeviceBufferMemoryRequirements const &rhs) noexcept;
bool operator!=(VkDeviceBufferMemoryRequirements const &lhs,
                VkDeviceBufferMemoryRequirements const &rhs) noexcept;
...
bool operator==(VkDeviceImageMemoryRequirements const &lhs,
                VkDeviceImageMemoryRequirements const &rhs) noexcept;
bool operator!=(VkDeviceImageMemoryRequirements const &lhs,
                VkDeviceImageMemoryRequirements const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceInlineUniformBlockFeatures const &lhs,
                VkPhysicalDeviceInlineUniformBlockFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceInlineUniformBlockFeatures const &lhs,
                VkPhysicalDeviceInlineUniformBlockFeatures const &rhs) noexcept;

bool operator==(VkPhysicalDeviceInlineUniformBlockProperties const &lhs,
                VkPhysicalDeviceInlineUniformBlockProperties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceInlineUniformBlockProperties const &lhs,
                VkPhysicalDeviceInlineUniformBlockProperties const &rhs) noexcept;

bool operator==(VkWriteDescriptorSetInlineUniformBlock const &lhs,
                VkWriteDescriptorSetInlineUniformBlock const &rhs) noexcept;
bool operator!=(VkWriteDescriptorSetInlineUniformBlock const &lhs,
                VkWriteDescriptorSetInlineUniformBlock const &rhs) noexcept;

bool operator==(VkDescriptorPoolInlineUniformBlockCreateInfo const &lhs,
                VkDescriptorPoolInlineUniformBlockCreateInfo const &rhs) noexcept;
bool operator!=(VkDescriptorPoolInlineUniformBlockCreateInfo const &lhs,
                VkDescriptorPoolInlineUniformBlockCreateInfo const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceMaintenance4Features const &lhs,
                VkPhysicalDeviceMaintenance4Features const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceMaintenance4Features const &lhs,
                VkPhysicalDeviceMaintenance4Features const &rhs) noexcept;

bool operator==(VkPhysicalDeviceMaintenance4Properties const &lhs,
                VkPhysicalDeviceMaintenance4Properties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceMaintenance4Properties const &lhs,
                VkPhysicalDeviceMaintenance4Properties const &rhs) noexcept;
...
bool operator==(VkDeviceQueueGlobalPriorityCreateInfoKHR const &lhs,
                VkDeviceQueueGlobalPriorityCreateInfoKHR const &rhs) noexcept;
bool operator!=(VkDeviceQueueGlobalPriorityCreateInfoKHR const &lhs,
                VkDeviceQueueGlobalPriorityCreateInfoKHR const &rhs) noexcept;

bool operator==(VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR const &lhs,
                VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR const &lhs,
                VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR const &rhs) noexcept;

bool operator==(VkQueueFamilyGlobalPriorityPropertiesKHR const &lhs,
                VkQueueFamilyGlobalPriorityPropertiesKHR const &rhs) noexcept;
bool operator!=(VkQueueFamilyGlobalPriorityPropertiesKHR const &lhs,
                VkQueueFamilyGlobalPriorityPropertiesKHR const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM const &lhs,
                VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM const &lhs,
                VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM const &lhs,
                VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM const &lhs,
                VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM const &rhs) noexcept;
...
bool operator==(VkSubpassFragmentDensityMapOffsetEndInfoQCOM const &lhs,
                VkSubpassFragmentDensityMapOffsetEndInfoQCOM const &rhs) noexcept;
bool operator!=(VkSubpassFragmentDensityMapOffsetEndInfoQCOM const &lhs,
                VkSubpassFragmentDensityMapOffsetEndInfoQCOM const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceTextureCompressionASTCHDRFeatures const &lhs,
                VkPhysicalDeviceTextureCompressionASTCHDRFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceTextureCompressionASTCHDRFeatures const &lhs,
                VkPhysicalDeviceTextureCompressionASTCHDRFeatures const &rhs) noexcept;
...
bool operator==(VkPipelineCreationFeedback const &lhs,
                VkPipelineCreationFeedback const &rhs) noexcept;
bool operator!=(VkPipelineCreationFeedback const &lhs,
                VkPipelineCreationFeedback const &rhs) noexcept;

bool operator==(VkPipelineCreationFeedbackCreateInfo const &lhs,
                VkPipelineCreationFeedbackCreateInfo const &rhs) noexcept;
bool operator!=(VkPipelineCreationFeedbackCreateInfo const &lhs,
                VkPipelineCreationFeedbackCreateInfo const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures const &lhs,
                VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures const &lhs,
                VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceTexelBufferAlignmentProperties const &lhs,
                VkPhysicalDeviceTexelBufferAlignmentProperties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceTexelBufferAlignmentProperties const &lhs,
                VkPhysicalDeviceTexelBufferAlignmentProperties const &rhs) noexcept;

bool operator==(VkPhysicalDeviceSubgroupSizeControlFeatures const &lhs,
                VkPhysicalDeviceSubgroupSizeControlFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceSubgroupSizeControlFeatures const &lhs,
                VkPhysicalDeviceSubgroupSizeControlFeatures const &rhs) noexcept;

bool operator==(VkPhysicalDeviceSubgroupSizeControlProperties const &lhs,
                VkPhysicalDeviceSubgroupSizeControlProperties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceSubgroupSizeControlProperties const &lhs,
                VkPhysicalDeviceSubgroupSizeControlProperties const &rhs) noexcept;

bool operator==(VkPipelineShaderStageRequiredSubgroupSizeCreateInfo const &lhs,
                VkPipelineShaderStageRequiredSubgroupSizeCreateInfo const &rhs) noexcept;
bool operator!=(VkPipelineShaderStageRequiredSubgroupSizeCreateInfo const &lhs,
                VkPipelineShaderStageRequiredSubgroupSizeCreateInfo const &rhs) noexcept;
...
bool operator==(VkPhysicalDevicePipelineCreationCacheControlFeatures const &lhs,
                VkPhysicalDevicePipelineCreationCacheControlFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDevicePipelineCreationCacheControlFeatures const &lhs,
                VkPhysicalDevicePipelineCreationCacheControlFeatures const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceVulkan13Features const &lhs,
                VkPhysicalDeviceVulkan13Features const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceVulkan13Features const &lhs,
                VkPhysicalDeviceVulkan13Features const &rhs) noexcept;

bool operator==(VkPhysicalDeviceVulkan13Properties const &lhs,
                VkPhysicalDeviceVulkan13Properties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceVulkan13Properties const &lhs,
                VkPhysicalDeviceVulkan13Properties const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceToolProperties const &lhs,
                VkPhysicalDeviceToolProperties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceToolProperties const &lhs,
                VkPhysicalDeviceToolProperties const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures const &lhs,
                VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures const &lhs,
                VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceImageRobustnessFeatures const &lhs,
                VkPhysicalDeviceImageRobustnessFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceImageRobustnessFeatures const &lhs,
                VkPhysicalDeviceImageRobustnessFeatures const &rhs) noexcept;
...
bool operator==(VkBufferCopy2 const &lhs,
                VkBufferCopy2 const &rhs) noexcept;
bool operator!=(VkBufferCopy2 const &lhs,
                VkBufferCopy2 const &rhs) noexcept;

bool operator==(VkImageCopy2 const &lhs,
                VkImageCopy2 const &rhs) noexcept;
bool operator!=(VkImageCopy2 const &lhs,
                VkImageCopy2 const &rhs) noexcept;

bool operator==(VkImageBlit2 const &lhs,
                VkImageBlit2 const &rhs) noexcept;
bool operator!=(VkImageBlit2 const &lhs,
                VkImageBlit2 const &rhs) noexcept;

bool operator==(VkBufferImageCopy2 const &lhs,
                VkBufferImageCopy2 const &rhs) noexcept;
bool operator!=(VkBufferImageCopy2 const &lhs,
                VkBufferImageCopy2 const &rhs) noexcept;

bool operator==(VkImageResolve2 const &lhs,
                VkImageResolve2 const &rhs) noexcept;
bool operator!=(VkImageResolve2 const &lhs,
                VkImageResolve2 const &rhs) noexcept;

bool operator==(VkCopyBufferInfo2 const &lhs,
                VkCopyBufferInfo2 const &rhs) noexcept;
bool operator!=(VkCopyBufferInfo2 const &lhs,
                VkCopyBufferInfo2 const &rhs) noexcept;

bool operator==(VkCopyImageInfo2 const &lhs,
                VkCopyImageInfo2 const &rhs) noexcept;
bool operator!=(VkCopyImageInfo2 const &lhs,
                VkCopyImageInfo2 const &rhs) noexcept;

bool operator==(VkBlitImageInfo2 const &lhs,
                VkBlitImageInfo2 const &rhs) noexcept;
bool operator!=(VkBlitImageInfo2 const &lhs,
                VkBlitImageInfo2 const &rhs) noexcept;

bool operator==(VkCopyBufferToImageInfo2 const &lhs,
                VkCopyBufferToImageInfo2 const &rhs) noexcept;
bool operator!=(VkCopyBufferToImageInfo2 const &lhs,
                VkCopyBufferToImageInfo2 const &rhs) noexcept;

bool operator==(VkCopyImageToBufferInfo2 const &lhs,
                VkCopyImageToBufferInfo2 const &rhs) noexcept;
bool operator!=(VkCopyImageToBufferInfo2 const &lhs,
                VkCopyImageToBufferInfo2 const &rhs) noexcept;

bool operator==(VkResolveImageInfo2 const &lhs,
                VkResolveImageInfo2 const &rhs) noexcept;
bool operator!=(VkResolveImageInfo2 const &lhs,
                VkResolveImageInfo2 const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceShaderTerminateInvocationFeatures const &lhs,
                VkPhysicalDeviceShaderTerminateInvocationFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceShaderTerminateInvocationFeatures const &lhs,
                VkPhysicalDeviceShaderTerminateInvocationFeatures const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceDepthClipControlFeaturesEXT const &lhs,
                VkPhysicalDeviceDepthClipControlFeaturesEXT const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceDepthClipControlFeaturesEXT const &lhs,
                VkPhysicalDeviceDepthClipControlFeaturesEXT const &rhs) noexcept;

bool operator==(VkPipelineViewportDepthClipControlCreateInfoEXT const &lhs,
                VkPipelineViewportDepthClipControlCreateInfoEXT const &rhs) noexcept;
bool operator!=(VkPipelineViewportDepthClipControlCreateInfoEXT const &lhs,
                VkPipelineViewportDepthClipControlCreateInfoEXT const &rhs) noexcept;
...
bool operator==(VkMemoryBarrier2 const &lhs,
                VkMemoryBarrier2 const &rhs) noexcept;
bool operator!=(VkMemoryBarrier2 const &lhs,
                VkMemoryBarrier2 const &rhs) noexcept;

bool operator==(VkImageMemoryBarrier2 const &lhs,
                VkImageMemoryBarrier2 const &rhs) noexcept;
bool operator!=(VkImageMemoryBarrier2 const &lhs,
                VkImageMemoryBarrier2 const &rhs) noexcept;

bool operator==(VkBufferMemoryBarrier2 const &lhs,
                VkBufferMemoryBarrier2 const &rhs) noexcept;
bool operator!=(VkBufferMemoryBarrier2 const &lhs,
                VkBufferMemoryBarrier2 const &rhs) noexcept;

bool operator==(VkDependencyInfo const &lhs,
                VkDependencyInfo const &rhs) noexcept;
bool operator!=(VkDependencyInfo const &lhs,
                VkDependencyInfo const &rhs) noexcept;

bool operator==(VkSemaphoreSubmitInfo const &lhs,
                VkSemaphoreSubmitInfo const &rhs) noexcept;
bool operator!=(VkSemaphoreSubmitInfo const &lhs,
                VkSemaphoreSubmitInfo const &rhs) noexcept;

bool operator==(VkCommandBufferSubmitInfo const &lhs,
                VkCommandBufferSubmitInfo const &rhs) noexcept;
bool operator!=(VkCommandBufferSubmitInfo const &lhs,
                VkCommandBufferSubmitInfo const &rhs) noexcept;

bool operator==(VkSubmitInfo2 const &lhs,
                VkSubmitInfo2 const &rhs) noexcept;
bool operator!=(VkSubmitInfo2 const &lhs,
                VkSubmitInfo2 const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceSynchronization2Features const &lhs,
                VkPhysicalDeviceSynchronization2Features const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceSynchronization2Features const &lhs,
                VkPhysicalDeviceSynchronization2Features const &rhs) noexcept;
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkQueueFamilyQueryResultStatusProperties2KHR const &lhs,
                VkQueueFamilyQueryResultStatusProperties2KHR const &rhs) noexcept;
bool operator!=(VkQueueFamilyQueryResultStatusProperties2KHR const &lhs,
                VkQueueFamilyQueryResultStatusProperties2KHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeRateControlLayerInfoKHR const &lhs,
                VkVideoEncodeRateControlLayerInfoKHR const &rhs) noexcept;
bool operator!=(VkVideoEncodeRateControlLayerInfoKHR const &lhs,
                VkVideoEncodeRateControlLayerInfoKHR const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH264RateControlInfoEXT const &lhs,
                VkVideoEncodeH264RateControlInfoEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH264RateControlInfoEXT const &lhs,
                VkVideoEncodeH264RateControlInfoEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH264QpEXT const &lhs,
                VkVideoEncodeH264QpEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH264QpEXT const &lhs,
                VkVideoEncodeH264QpEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH264FrameSizeEXT const &lhs,
                VkVideoEncodeH264FrameSizeEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH264FrameSizeEXT const &lhs,
                VkVideoEncodeH264FrameSizeEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH264RateControlLayerInfoEXT const &lhs,
                VkVideoEncodeH264RateControlLayerInfoEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH264RateControlLayerInfoEXT const &lhs,
                VkVideoEncodeH264RateControlLayerInfoEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH265RateControlInfoEXT const &lhs,
                VkVideoEncodeH265RateControlInfoEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH265RateControlInfoEXT const &lhs,
                VkVideoEncodeH265RateControlInfoEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH265QpEXT const &lhs,
                VkVideoEncodeH265QpEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH265QpEXT const &lhs,
                VkVideoEncodeH265QpEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH265FrameSizeEXT const &lhs,
                VkVideoEncodeH265FrameSizeEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH265FrameSizeEXT const &lhs,
                VkVideoEncodeH265FrameSizeEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS

#ifdef VK_ENABLE_BETA_EXTENSIONS
bool operator==(VkVideoEncodeH265RateControlLayerInfoEXT const &lhs,
                VkVideoEncodeH265RateControlLayerInfoEXT const &rhs) noexcept;
bool operator!=(VkVideoEncodeH265RateControlLayerInfoEXT const &lhs,
                VkVideoEncodeH265RateControlLayerInfoEXT const &rhs) noexcept;
#endif // VK_ENABLE_BETA_EXTENSIONS
...
bool operator==(VkPhysicalDeviceShaderIntegerDotProductFeatures const &lhs,
                VkPhysicalDeviceShaderIntegerDotProductFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceShaderIntegerDotProductFeatures const &lhs,
                VkPhysicalDeviceShaderIntegerDotProductFeatures const &rhs) noexcept;

bool operator==(VkPhysicalDeviceShaderIntegerDotProductProperties const &lhs,
                VkPhysicalDeviceShaderIntegerDotProductProperties const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceShaderIntegerDotProductProperties const &lhs,
                VkPhysicalDeviceShaderIntegerDotProductProperties const &rhs) noexcept;
...
bool operator==(VkFormatProperties3 const &lhs,
                VkFormatProperties3 const &rhs) noexcept;
bool operator!=(VkFormatProperties3 const &lhs,
                VkFormatProperties3 const &rhs) noexcept;
...
bool operator==(VkPipelineRenderingCreateInfo const &lhs,
                VkPipelineRenderingCreateInfo const &rhs) noexcept;
bool operator!=(VkPipelineRenderingCreateInfo const &lhs,
                VkPipelineRenderingCreateInfo const &rhs) noexcept;

bool operator==(VkRenderingInfo const &lhs,
                VkRenderingInfo const &rhs) noexcept;
bool operator!=(VkRenderingInfo const &lhs,
                VkRenderingInfo const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceDynamicRenderingFeatures const &lhs,
                VkPhysicalDeviceDynamicRenderingFeatures const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceDynamicRenderingFeatures const &lhs,
                VkPhysicalDeviceDynamicRenderingFeatures const &rhs) noexcept;

bool operator==(VkCommandBufferInheritanceRenderingInfo const &lhs,
                VkCommandBufferInheritanceRenderingInfo const &rhs) noexcept;
bool operator!=(VkCommandBufferInheritanceRenderingInfo const &lhs,
                VkCommandBufferInheritanceRenderingInfo const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceImageViewMinLodFeaturesEXT const &lhs,
                VkPhysicalDeviceImageViewMinLodFeaturesEXT const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceImageViewMinLodFeaturesEXT const &lhs,
                VkPhysicalDeviceImageViewMinLodFeaturesEXT const &rhs) noexcept;

bool operator==(VkImageViewMinLodCreateInfoEXT const &lhs,
                VkImageViewMinLodCreateInfoEXT const &rhs) noexcept;
bool operator!=(VkImageViewMinLodCreateInfoEXT const &lhs,
                VkImageViewMinLodCreateInfoEXT const &rhs) noexcept;

bool operator==(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM const &lhs,
                VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM const &lhs,
                VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM const &rhs) noexcept;

bool operator==(VkPhysicalDeviceLinearColorAttachmentFeaturesNV const &lhs,
                VkPhysicalDeviceLinearColorAttachmentFeaturesNV const &rhs) noexcept;
bool operator!=(VkPhysicalDeviceLinearColorAttachmentFeaturesNV const &lhs,
                VkPhysicalDeviceLinearColorAttachmentFeaturesNV const &rhs) noexcept;
...
bool operator==(VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM const &lhs,
                VkPhysicalDeviceFragmentDensityMapOffsetFeaturesQCOM const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.fragmentDensityMapOffset == rhs.fragmentDensityMapOffset);
}
...
bool operator==(VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM const &lhs,
                VkPhysicalDeviceFragmentDensityMapOffsetPropertiesQCOM const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.fragmentDensityOffsetGranularity == rhs.fragmentDensityOffsetGranularity);
}
...
bool operator==(VkSubpassFragmentDensityMapOffsetEndInfoQCOM const &lhs,
                VkSubpassFragmentDensityMapOffsetEndInfoQCOM const &rhs) noexcept {
  if(lhs.fragmentDensityOffsetCount != rhs.fragmentDensityOffsetCount)
    return false;

  for(uint32_t i = 0; i < lhs.fragmentDensityOffsetCount; ++i) {
    if(lhs.pFragmentDensityOffsets[i] != rhs.pFragmentDensityOffsets[i])
      return false;
  }
...
bool operator==(VkPhysicalDeviceVulkan13Properties const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.maxDescriptorSetInlineUniformBlocks == rhs.maxDescriptorSetInlineUniformBlocks) &&
         (lhs.maxDescriptorSetUpdateAfterBindInlineUniformBlocks == rhs.maxDescriptorSetUpdateAfterBindInlineUniformBlocks) &&
         (lhs.maxInlineUniformTotalSize == rhs.maxInlineUniformTotalSize) &&
...
bool operator==(VkPhysicalDeviceDepthClipControlFeaturesEXT const &lhs,
                VkPhysicalDeviceDepthClipControlFeaturesEXT const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.depthClipControl == rhs.depthClipControl);
}
...
bool operator==(VkPipelineViewportDepthClipControlCreateInfoEXT const &lhs,
                VkPipelineViewportDepthClipControlCreateInfoEXT const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.negativeOneToOne == rhs.negativeOneToOne);
}
...
bool operator==(VkVideoEncodeInfoKHR const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.pSetupReferenceSlot == rhs.pSetupReferenceSlot) &&
         (lhs.precedingExternallyEncodedBytes == rhs.precedingExternallyEncodedBytes);
}
...
bool operator==(VkVideoEncodeRateControlInfoKHR const &lhs,
  ...
  for(uint32_t i = 0; i < lhs.layerCount; ++i) {
    if(lhs.pLayerConfigs[i] != rhs.pLayerConfigs[i])
      return false;
  }
...
bool operator==(VkVideoEncodeRateControlLayerInfoKHR const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.initialVirtualBufferSizeInMs == rhs.initialVirtualBufferSizeInMs);
}
...
bool operator==(VkVideoEncodeH264RateControlInfoEXT const &lhs,
                VkVideoEncodeH264RateControlInfoEXT const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.gopFrameCount == rhs.gopFrameCount) &&
         (lhs.idrPeriod == rhs.idrPeriod) &&
         (lhs.consecutiveBFrameCount == rhs.consecutiveBFrameCount) &&
         (lhs.rateControlStructure == rhs.rateControlStructure) &&
         (lhs.temporalLayerCount == rhs.temporalLayerCount);
}
...
bool operator==(VkVideoEncodeH264FrameSizeEXT const &lhs,
                VkVideoEncodeH264FrameSizeEXT const &rhs) noexcept {
  return (lhs.frameISize == rhs.frameISize) &&
         (lhs.framePSize == rhs.framePSize) &&
         (lhs.frameBSize == rhs.frameBSize);
}
...
bool operator==(VkVideoEncodeH264RateControlLayerInfoEXT const &lhs,
                VkVideoEncodeH264RateControlLayerInfoEXT const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.temporalLayerId == rhs.temporalLayerId) &&
         (lhs.useInitialRcQp == rhs.useInitialRcQp) &&
         (lhs.initialRcQp == rhs.initialRcQp) &&
         (lhs.useMinQp == rhs.useMinQp) &&
         (lhs.minQp == rhs.minQp) &&
         (lhs.useMaxQp == rhs.useMaxQp) &&
         (lhs.maxQp == rhs.maxQp) &&
         (lhs.useMaxFrameSize == rhs.useMaxFrameSize) &&
         (lhs.maxFrameSize == rhs.maxFrameSize);
}
...
bool operator==(VkVideoEncodeH265RateControlInfoEXT const &lhs,
  ...
  return (lhs.sType == rhs.sType) &&
         ...
         (lhs.consecutiveBFrameCount == rhs.consecutiveBFrameCount) &&
         (lhs.rateControlStructure == rhs.rateControlStructure) &&
         (lhs.subLayerCount == rhs.subLayerCount);
}
...
bool operator==(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM const &lhs,
                VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.rasterizationOrderColorAttachmentAccess == rhs.rasterizationOrderColorAttachmentAccess) &&
         (lhs.rasterizationOrderDepthAttachmentAccess == rhs.rasterizationOrderDepthAttachmentAccess) &&
         (lhs.rasterizationOrderStencilAttachmentAccess == rhs.rasterizationOrderStencilAttachmentAccess);
}
...
bool operator==(VkPhysicalDeviceLinearColorAttachmentFeaturesNV const &lhs,
                VkPhysicalDeviceLinearColorAttachmentFeaturesNV const &rhs) noexcept {
  return (lhs.sType == rhs.sType) &&
         (lhs.linearColorAttachment == rhs.linearColorAttachment);
}
...
#endif // VK_EQUALITY_CHECK_V204_HPP
